...
const experiences = [
  {
    ...
    summary:
      "Conducting qualitative and quantitative research to understand user needs, behaviors, and pain points.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Crafting compelling content that engages audiences and drives meaningful interactions.",
    details: [
      "Custom Website Development",
      "Frontend & Backend Solutions",
      "E-commerce Development",
